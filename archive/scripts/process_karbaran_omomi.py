...
# -*- coding: utf-8 -*-
"""
پردازش فایل karbaran-omomi.xlsx و ایجاد collection برای RAG
"""
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('/home/user01/qwen-api/enhanced_rag_system/process_karbaran_omomi.log')
    ]
)
...
EXCEL_FILE_PATH = "/home/user01/qwen-api/enhanced_rag_system/karbaran-omomi.xlsx"
...
async def test_collection(rag_system: UltimateRAGSystem):
    ...
    test_queries = [
        ...
        "چه اطلاعاتی در مورد کاربران عمومی وجود دارد؟",
        "کاربران عمومی چه دسترسی‌هایی دارند؟",
    ...
    for i, query in enumerate(test_queries, 1):
        ...
        try:
            ...
            if response.get("success"):
                ...
                confidence = response.get("top_score", 0.0)
...
async def main():
    """تابع اصلی"""
    logger.info("\n" + "="*80)
    logger.info("🚀 پردازش فایل karbaran-omomi.xlsx")
    logger.info("="*80)
