...
# -*- coding: utf-8 -*-
"""
تست سیستم Smart - بررسی نهایی ساختار سند
"""
...
async def test_smart_system():
    ...
    try:
        ...
        result = await rag_system.process_pdf_advanced(
            ...
            collection_name='budget_smart_analysis'
        )
        ...
        if result.get('success'):
            ...
            # تست‌های Smart
            await test_smart_queries(rag_system)
        else:
...
async def test_smart_queries(rag_system):
    """تست‌های Smart ساختار سند"""
    
    print("\n" + "="*100)
    print("🧪 شروع تست‌های Smart ساختار سند...")
    print("="*100)
