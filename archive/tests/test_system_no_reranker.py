...
# -*- coding: utf-8 -*-
"""
تست سیستم Ultimate RAG بدون reranker
"""
...
async def test_system_no_reranker():
    """تست سیستم بدون reranker"""
    
    print("🚀 راه‌اندازی سیستم Ultimate RAG بدون reranker...")
    
    try:
        # راه‌اندازی سیستم بدون reranker
...
if __name__ == "__main__":
    asyncio.run(test_system_no_reranker())
