...
# -*- coding: utf-8 -*-
"""
تست سیستم Ultimate - بررسی نهایی ساختار سند
"""
...
async def test_ultimate_system():
    ...
    print("🚀 راه‌اندازی سیستم Ultimate...")
    ...
    try:
        ...
        result = await rag_system.process_pdf_advanced(
            ...
            collection_name='budget_ultimate_analysis'
        )
        ...
        if result.get('success'):
            ...
            # تست‌های Ultimate
            await test_ultimate_queries(rag_system)
        else:
...
async def test_ultimate_queries(rag_system):
    """تست‌های Ultimate ساختار سند"""
    
    print("\n" + "="*100)
    print("🧪 شروع تست‌های Ultimate ساختار سند...")
    print("="*100)
