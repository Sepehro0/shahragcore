...
# -*- coding: utf-8 -*-
"""
تست سیستم هیبریدی - بررسی سلسله مراتبی داینامیک
"""
...
async def test_hybrid_system():
    ...
    print("🚀 راه‌اندازی سیستم هیبریدی...")
    ...
    try:
        ...
        result = await rag_system.process_pdf_advanced(
            ...
            collection_name='budget_document_hybrid'
        )
        ...
        if result.get('success'):
            ...
            # تست‌های هیبریدی
            await test_hybrid_queries(rag_system)
        else:
...
async def test_hybrid_queries(rag_system):
    """تست‌های هیبریدی ساختار سند"""
    
    print("\n" + "="*100)
    print("🧪 شروع تست‌های هیبریدی ساختار سند...")
    print("="*100)
