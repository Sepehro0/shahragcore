...
# -*- coding: utf-8 -*-
"""
تست سیستم Enhanced - بررسی نهایی ساختار سند
"""
...
async def test_enhanced_system():
    ...
    print("🚀 راه‌اندازی سیستم Enhanced...")
    ...
    try:
        ...
        result = await rag_system.process_pdf_advanced(
            ...
            collection_name='budget_enhanced_analysis'
        )
        ...
        if result.get('success'):
            ...
            # تست‌های Enhanced
            await test_enhanced_queries(rag_system)
        else:
...
async def test_enhanced_queries(rag_system):
    """تست‌های Enhanced ساختار سند"""
    
    print("\n" + "="*100)
    print("🧪 شروع تست‌های Enhanced ساختار سند...")
    print("="*100)
